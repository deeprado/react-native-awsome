        ...
        <View style={styles.userPanel}>
          ...
          <View
            style={[
              ...
              {top: this.state.iconTop, transform: [{scale: this.state.scale}]},
            ]}>
            <Image style={styles.icon} source={{uri: 'icon'}} />
          </View>
          <View style={styles.userControl}>
            <TouchableHighlight activeOpacity={1} style={styles.controlIcon}>
              <Icon name="ios-settings" color="#8999a5" size={20} />
            </TouchableHighlight>
            <TouchableHighlight activeOpacity={1} style={styles.controlBtn}>
              <Icon name="ios-people" color="#8999a5" size={20} />
            </TouchableHighlight>
            <TouchableHighlight activeOpacity={1} style={styles.controlBtn2}>
