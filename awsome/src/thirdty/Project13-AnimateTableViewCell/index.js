...
import {View, Text, Animated, Easing, FlatList, StyleSheet} from 'react-native';
...
@autobind
class AnimateTableViewCell extends React.Component {
  constructor() {
    super();
    this.state = {
...
export default AnimateTableViewCell;
