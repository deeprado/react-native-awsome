...
export default class Home extends Component {
  ...
  //   };
  _loadmore() {
    const url = `https://route.showapi.com/181-1?showapi_appid=30603&showapi_sign=98960666afeb4992ae91971d13494090&page=${++this
      .state.page}&num=20`;
    const opts = {
      method: 'GET',
    };
    fetch(url, opts)
      ...
      .then(res => {
        ...
        this.setState({
          isloading: true,
          dataResouse: this.state.dataResouse.concat(
  ...
  componentWillMount() {
    const url = `https://route.showapi.com/181-1?showapi_appid=30603&showapi_sign=98960666afeb4992ae91971d13494090&page=${
      this.state.page
    }&num=20`;
    const opts = {
      method: 'GET',
