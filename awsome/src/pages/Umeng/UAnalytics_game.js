...
import AnalyticsUtil from '../../components/umeng/AnalyticsUtil';
  ...
  render() {
    ...
    return (
      <View style={styles.u_c}>
        ...
        <TouchableOpacity style={styles.u_c_item} onPress={this.pay.bind(this)}>
        ...
        <TouchableOpacity style={styles.u_c_item} onPress={this.use.bind(this)}>
