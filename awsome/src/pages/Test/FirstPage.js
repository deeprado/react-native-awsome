  ...
  static navigationOptions = ({navigation, screenProps}) => ({
    ...
    headerRight: (
      <TouchableOpacity
        ...
        disabled={
          navigation.state.params ? navigation.state.params.disable : false
        }
        onPress={() => {
          const {params = {}} = navigation.state;
          params.showAlert();
        }}>
        <Text style={{fontSize: 14, color: '#333'}}>新增</Text>
      </TouchableOpacity>
    ),
  });
  ...
  constructor(props) {
    ...
    this.staggerAnimated = Animated.stagger(2000, [
      Animated.stagger(800, [
        Animated.timing(this.state.titleFontSize, {
          toValue: 25,
          duration: 1200,
          easing: Easing.in,
        }),
        Animated.parallel([
          ...
          Animated.timing(this.state.titleMarginLeft, {
            toValue: 200,
            duration: 2000,
            easing: Easing.in,
          }),
    ...
    return (
      <View style={{flex: 1}}>
        <TouchableOpacity
          ...
          <Animated.Text
            style={{
              backgroundColor: this.state.colorValue.interpolate({
                inputRange: [0, 1],
