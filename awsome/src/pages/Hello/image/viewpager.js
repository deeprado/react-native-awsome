  ...
  _renderPage(data, pageID) {
    ...
    return (
      <View style={{flex: 1}}>
        <TouchableWithoutFeedback
          onPress={() =>
            this.setState({statusBarHide: !this.state.statusBarHide})
          }>
          <Image source={{uri: data}} style={{flex: 1}} resizeMode="contain" />
        </TouchableWithoutFeedback>
      </View>
    );
  }
      ...
      <View style={styles.container}>
        ...
        <TouchableOpacity
          style={{
            ...
            top: 20,
            left: 10,
            height: this.state.statusBarHide ? 0 : null,
          }}
          onPress={() => {
            Actions.pop();
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            let a = CameraRoll.saveToCameraRoll(
              'http://wx3.sinaimg.cn/mw600/661eb95cgy1fcejzv2cz2j20hs0qo76c.jpg',
              'photo',
            );
            a.then(e =>
